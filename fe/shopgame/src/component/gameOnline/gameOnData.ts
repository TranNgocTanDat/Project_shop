...
export interface CartItem extends GameOnItem {
  qty: number;
}

const gameOnItem1: GameOnItem[] = [
  {
    id: 11,
    discount: 50,
...
export { gameOnItem1, gameOnItem2, cartItems };
